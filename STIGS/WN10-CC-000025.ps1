<#
.SYNOPSIS
    This PowerShell script disables IP source routing for IPv4 by setting DisableIPSourceRouting to 2 per STIG WN10-CC-000025.
...
$ValueData = 2  # Disable IP source routing (IPv4)
