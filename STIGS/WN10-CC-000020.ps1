<#
.SYNOPSIS
    This PowerShell script disables IP source routing for IPv6 by setting DisableIpSourceRouting to 2 per STIG WN10-CC-000020.
...
$ValueData = 2  # Disable IP source routing
